...
const ptBR: Dict = {
  ...
  wizard: {
    ...
    pairTab: "Código de pareamento (recomendado)",
    commandTab: "Copiar comando",
    pairSub: "Gere um código de 6 dígitos de uso único e leia para o seu agente. O token nunca aparece no chat.",
    generateCode: "Gerar código de pareamento",
    pairHint: "Leia esses 6 dígitos para o seu agente, ou entregue o comando de troca abaixo. O código vale uma vez e expira em 10 minutos.",
    pairNote: "o agente troca o código pelo token real em /api/pair · o token nunca passa pela conversa",
    pairWaiting: "Passe o código para o seu agente. Eu acendo quando parear.",
    generating: "Gerando…",
    copy: "Copiar",
    copied: "Copiado",
